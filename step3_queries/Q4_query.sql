-- 4. Find the most collaborative authors who published in a conference or journal 
-- whose name contains “data” (e.g., ACM SIGKDD International Conference on Knowledge 
-- Discovery and Data Mining). That is, for each author determine its number of collaborators, 
-- and then find the author with the most number of collaborators. Hint: for this question 
-- you may want to compute a temporary table of coauthors.
